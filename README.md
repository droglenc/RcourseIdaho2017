...
* Download the Slides, R scripts, and data for the course ([available below](#course-materials)). *Please wait to do this to as close to the start of the workshop as possible.*
